...
public class HomePageLocators extends ActionEngine {
	...
	public static By notificationPopUp = By.xpath("//*[@name='OK']"); 
	...
	//Main Menu locators
	public static By mainMenuIcon =  By.xpath("//UIANavigationBar[1]/UIAButton[1]");
	...
	public static String sideMenuUITable1 = "target.frontMostApp().mainWindow().tableViews()[1].visibleCells()";
	public static String sideMenuUITable2 = "target.frontMostApp().mainWindow().tableViews()[0].visibleCells()";
	//in-house
