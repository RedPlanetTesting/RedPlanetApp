	...
	try{
		...
		/* if(isElementDisplayedTemp(BookPageLocators.iAMTheGuestRadio)){		 
		 ...
		 if(isElementDisplayed(BookPageLocators.bookingCode)){
			 ...
			 bookingToDate = driver.findElement(BookPageLocators.bookingToDate).getText().trim();
			 bookingFromDate = driver.findElement(BookPageLocators.bookingFromDate).getText().trim();
			 bookedHotel = driver.findElement(BookPageLocators.bookedHotel).getText().trim();
			 totalBookingCost = driver.findElement(BookPageLocators.totalBookingCost).getText().trim();
